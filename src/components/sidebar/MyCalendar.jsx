  ...
  return (
    <div className="bg-white rounded-lg py-2 shadow-sm">
      ...
      <button
        ...
        className="w-full flex justify-between items-center px-4 py-2 rounded text-sm font-semibold text-black cursor-pointer"
      >
        My Calendar
        ...
        <div className="px-4 py-2 text-sm text-gray space-y-2 border-t border-gray-200">
          ...
          {upcomingEvents.map((event, index) => (
            <div key={index} className="p-2 rounded-md bg-gray-50 hover:bg-gray-100">
              ...
              <div className="flex items-center text-xs text-gray font-medium mt-1">
